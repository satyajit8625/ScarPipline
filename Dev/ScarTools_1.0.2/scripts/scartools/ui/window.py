...
_diagnostics_dialog_instance = None


def show_diagnostics_dialog():
    global _diagnostics_dialog_instance
    try:
        if _diagnostics_dialog_instance is not None:
            _diagnostics_dialog_instance.close()
            _diagnostics_dialog_instance.deleteLater()
    except Exception:
        pass
    _diagnostics_dialog_instance = DiagnosticsDialog(parent=maya_main_window())
    _diagnostics_dialog_instance.show()
    _diagnostics_dialog_instance.raise_()
    _diagnostics_dialog_instance.activateWindow()
    return _diagnostics_dialog_instance
