...
def get_central_registry_path():
    ...
    package_root = os.path.dirname(os.path.dirname(this_dir))
    pipeline_root = os.path.dirname(os.path.dirname(package_root))
    candidates = [
        os.path.join(package_root, "admin_tools", "studio_licenses_registry.json"),
        os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(this_dir))), "admin_tools", "studio_licenses_registry.json"),
        os.path.join(pipeline_root, "Dev", "ScarTools_{}".format(VERSION), "admin_tools", "studio_licenses_registry.json"),
        r"O:\Rnd\Scripts\ScarPipline\Dev\ScarTools_{}\admin_tools\studio_licenses_registry.json".format(VERSION),
