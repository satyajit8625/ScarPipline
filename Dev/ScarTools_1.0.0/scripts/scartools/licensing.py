...
def get_central_registry_path():
    ...
    candidates = [
        ...
        os.path.join(os.path.dirname(os.path.dirname(os.path.dirname(this_dir))), "Dev", "ScarTools_1.0.0", "admin_tools", "studio_licenses_registry.json"),
        r"O:\Rnd\Scripts\ScarPipline\Dev\ScarTools_1.0.0\admin_tools\studio_licenses_registry.json",
